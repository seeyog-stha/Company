...
export default function Contactcomp() {
  return (
    <div>
      <div className="h-screen w-full bg-blue-200 py-4">
        <div className="h-5/6 w-9/12 border border-black mx-auto ">
          <h2 className="text-3xl text-center underline font-extrabold">
            Contact info
          </h2>
          <div className="flex h-5/6">
            <div className="w-1/2  border-r border-black m-7 space-y-9">
              {/* address  */}
            ...
            <div className="w-1/2 m-7 space-y-9 ">
                <div className=" w-11/12 h-full bg-white p-5 space-y-5">
                    <h3 className="text-2xl font-bold">Send message</h3>
                    <form action="" className="space-y-5" >
                        <input type="text" className="input input-sm input-bordered input-primary w-full " placeholder="Your Name"/>
                        <input type="email" name="" id="" className="input input-sm input-bordered input-primary w-full " placeholder="Email" />
                        <textarea name="" id="" className="textarea textarea-primary w-full" placeholder="Type your message"></textarea>
